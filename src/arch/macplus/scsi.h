...
void mac_scsi_ethernet_tap_open (mac_scsi_t *scsi, mac_scsi_dev_t *dev);
int mac_scsi_ethernet_data_avail (mac_scsi_dev_t *dev);
size_t mac_scsi_ethernet_read (mac_scsi_dev_t *dev, char *buf);
size_t mac_scsi_ethernet_write (mac_scsi_dev_t *dev, const char *buf, size_t len);
